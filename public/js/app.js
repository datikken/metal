...
/***/ "./resources/js/classes/CallbackFrom.js":
/*!**********************************************!*\
  !*** ./resources/js/classes/CallbackFrom.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (/* binding */ CallbackFrom)
/* harmony export */ });
...
var CallbackFrom = /*#__PURE__*/function () {
  function CallbackFrom() {
    _classCallCheck(this, CallbackFrom);
  ...
  _createClass(CallbackFrom, [{
    key: "set_listeners",
    value: function set_listeners() {
      var that = this;
      ...
      Livewire.on('contactCollected', function (postId) {
        var thanx_block = document.createElement('div');
        that.form.innerHTML = '';
        fetch('show_thanx').then(function (response) {
    ...
    key: "toggle_layout",
    value: function toggle_layout(action) {
      if (action) {
